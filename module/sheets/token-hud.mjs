const HORIZONLESS_TOKEN_CONDITIONS = Object.freeze([
  ...
  { id: "horizonless.mark_one", name: "Mark Triangle", img: "systems/horizonless/assets/icons/mark_triangle.svg" },
  { id: "horizonless.mark_two", name: "Mark Energy", img: "systems/horizonless/assets/icons/mark_energy.svg" },
  { id: "horizonless.bolster_one", name: "Bolster Star", img: "systems/horizonless/assets/icons/bolster_star.svg" },
  { id: "horizonless.bolster_two", name: "Bolster Defence", img: "systems/horizonless/assets/icons/bolster_defence.svg" },
  { id: "horizonless.bolster_three", name: "Bolster Offence", img: "systems/horizonless/assets/icons/bolster_offence.svg" },
  { id: "horizonless.mark_three", name: "Mark Eye", img: "systems/horizonless/assets/icons/mark_eye.svg" },
  { id: "horizonless.mark_four", name: "Mark Target", img: "systems/horizonless/assets/icons/mark_target.svg" },
  { id: "horizonless.bind_one", name: "Bind Star", img: "systems/horizonless/assets/icons/bind_star.svg" },
  { id: "horizonless.bind_two", name: "Bind Defence", img: "systems/horizonless/assets/icons/bind_defence.svg" },
  { id: "horizonless.bind_three", name: "Bind Offence", img: "systems/horizonless/assets/icons/bind_offence.svg" }
]);
